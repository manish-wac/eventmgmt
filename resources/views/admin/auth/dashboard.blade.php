                ...
                <div class="rich-list-prepend">
                  ...
                  <div class="avatar avatar-circle">
                    ...
                    <div class="avatar-display">
                      <img
                        src="{{asset('assets/theme/images/avatar/blank.webp')}}"
                        alt="Avatar image"
                      />
                    </div>
            ...
            <div class="form-group">
              ...
              <div class="custom-control custom-control-lg custom-switch">
                <input
                  ...
                  id="generalSetting1"
                />
                <label class="custom-control-label" for="generalSetting1"
            ...
            <div class="form-group">
              ...
              <div class="custom-control custom-control-lg custom-switch">
                <input
                  ...
                  checked="checked"
                />
                <label class="custom-control-label" for="generalSetting2"
            ...
            <div class="form-group mb-0">
              ...
              <div class="custom-control custom-control-lg custom-switch">
                <input
                  ...
                  id="generalSetting3"
                />
                <label class="custom-control-label" for="generalSetting3"
            ...
            <div class="form-group">
              ...
              <div class="custom-control custom-control-lg custom-switch">
                <input
                  ...
                  id="generalSetting4"
                />
                <label class="custom-control-label" for="generalSetting4"
            ...
            <div class="form-group">
              ...
              <div class="custom-control custom-control-lg custom-switch">
                <input
                  ...
                  checked="checked"
                />
                <label class="custom-control-label" for="generalSetting5"
            ...
            <div class="form-group mb-0">
              ...
              <div class="custom-control custom-control-lg custom-switch">
                <input
                  ...
                  id="generalSetting6"
                />
                <label class="custom-control-label" for="generalSetting6"
                  >Allow data</label
                >
              </div>
              <!-- END Custom Switch -->
            ...
            <div class="form-group">
              ...
              <div class="custom-control custom-control-lg custom-switch">
                <input
                  ...
                  id="generalSetting7"
                />
                <label class="custom-control-label" for="generalSetting7"
                  >Enable create projects</label
                >
              </div>
              <!-- END Custom Switch -->
            </div>
            ...
            <div class="form-group">
              ...
              <div class="custom-control custom-control-lg custom-switch">
                <input
                  ...
                  checked="checked"
                />
                <label class="custom-control-label" for="generalSetting8"
                  >Enable custom projects</label
                >
              </div>
              <!-- END Custom Switch -->
            </div>
            ...
            <div class="form-group mb-0">
              ...
              <div class="custom-control custom-control-lg custom-switch">
                <input
                  ...
                  id="generalSetting9"
                />
                <label class="custom-control-label" for="generalSetting9"
                  >Enable project review</label
                >
              </div>
              <!-- END Custom Switch -->
            </div>
