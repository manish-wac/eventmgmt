							...
							<div class="portlet">
								<div class="portlet-header portlet-header-bordered">
									...
									<div class="col-md-6 add-new">
										<a href="{{route('admin.location.merchant-unit.add')}}"><i style="font-size: 3em;" class="fa fa-3x fa-plus-circle"></i></a>
									</div>
								</div>
								...
								<div class="portlet-body">
									...
									<!-- BEGIN Datatable -->
									<table id="js-merchant-unit-list" class="table table-bordered table-striped table-hover">
										<thead>
											<tr>
                        						<th>ID</th>
												<th>Name</th>
...
@push('js')
<script type="text/javascript" src="{{asset('assets/js/admin/index-merchant-unit.js')}}"></script>

<script>
 $(function () {    
            var table = $('#js-merchant-unit-list').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin.location.merchant-unit.datatable') }}",
            columns: [
