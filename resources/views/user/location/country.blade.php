...
@section('content')
    ...
    <!-- BEGIN Page Content -->
			<div class="results" id="common-alert">
						...
						<div class="col-12">
							...
							<div class="portlet">
								<div class="portlet-header portlet-header-bordered">
									<h3 class="portlet-title">COUNTRY LIST</h3>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form action="{{ route('admin.location.add-new-country') }}" id="add-new-country-form" method="POST">
                    @csrf
					<input type="hidden" id="country-session" value="{{Session::get('country-fail') || $errors->has('js_country_code') || $errors->has('js_country_name')}}"/>
					<div class="results">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<div class="float-label float-label-lg">
								<input class="form-control form-control-lg @error('js_country_code') {{'is-invalid'}} @enderror" type="text" id="js-country-code" name="js_country_code" placeholder=" " value="{{old('js_country_code')}}">
            			...
            			<div class="form-group">
							<div class="float-label float-label-lg">
								<input class="form-control form-control-lg @error('js_country_name') {{'is-invalid'}} @enderror" type="text" id="js-country-name" name="js_country_name" placeholder=" " value="{{old('js_country_name')}}">
  ...
  <div class="modal fade" id="edit-country">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form action="{{ route('admin.location.update-country-details') }}" id="js-update-country-details" method="POST">
                    @csrf
					<input type="hidden" id="country-session" value="{{Session::get('country-update-fail') || $errors->has('js_update_cn_code') || $errors->has('js_update_cn_name') || $errors->has('collection_id')}}"/>
					<div class="results">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<div class="float-label float-label-lg">
								<input class="form-control form-control-lg @error('js_update_cn_code') {{'is-invalid'}} @enderror" type="text" id="js-update-cn-code" placeholder=" " name="js_update_cn_code" value="{{old('js_update_cn_code')}}">
								<label for="js-country-code">Country Code* </label>                                                
							</div>
            			...
            			<div class="form-group">
							<div class="float-label float-label-lg">
								<input class="form-control form-control-lg @error('js_update_cn_name') {{'is-invalid'}} @enderror" type="text" id="js-update-cn-name" placeholder=" " name="js_update_cn_name" value="{{old('js_update_cn_name')}}">
								<label for="js-country-name">Country Name* </label>                                                
							</div>
	...
	<!-- END Modal -->
  <!-- BEGIN Modal -->
  <div class="modal fade" id="show-jquery-fail-messages">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
...
@push('js')
    ...
    <script>
        $(function () {    
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin.auth.country-list') }}",
            columns: [
